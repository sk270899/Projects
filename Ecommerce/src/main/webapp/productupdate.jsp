...
<input type="text" name="Pname" placeholder="Enter Updated Name" required="required" oninvalid="this.setCustomValidity('Please Enter Name')" oninput="this.setCustomValidity('')"><br>
<span class="required">Enter Product Price:</span>
<input type="number" name="Pprice" placeholder="Enter Updated Price" required="required" oninvalid="this.setCustomValidity('Please Enter Price')" oninput="this.setCustomValidity('')"><br>
<span>Enter Product Category:</span>
<input type="text" name="Pcategory" placeholder="Enter Updated Category"><br>
<input type="submit">
